...
sealed class Screen(val route: String) {
    ...
    data object RecommendationsHistoryScreen : Screen("recommendations_history_screen")
    data object DailyRecommendationsScreen : Screen("daily_recommendations_screen")
